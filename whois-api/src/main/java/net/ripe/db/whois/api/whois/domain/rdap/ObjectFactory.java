 ...
 * generated in the net.ripe.db.whois.api.whois.domain.rdap package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.ripe.db.whois.api.whois.domain.rdap
     * 
     */
