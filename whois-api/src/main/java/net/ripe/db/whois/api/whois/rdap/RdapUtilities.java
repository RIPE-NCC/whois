...
public class RdapUtilities {
    public static RpslObject fetchObject(QueryHandler queryHandler,
                                         final String type,
                                         final String key,
                                         final String source) {
        final String qstring =
            String.format("%s %s %s %s %s %s",
                ...
                QueryFlag.SELECT_TYPES.getLongFlag(),  type,
                QueryFlag.SHOW_TAG_INFO.getLongFlag(), key
            );
