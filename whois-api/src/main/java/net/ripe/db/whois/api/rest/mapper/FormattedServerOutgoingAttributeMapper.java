...
@Component
public class FormattedServerOutgoingAttributeMapper
    ...
    @Autowired
    public FormattedServerOutgoingAttributeMapper(final ChangedAttrFeatureToggle changedAttrFeatureToggle,
