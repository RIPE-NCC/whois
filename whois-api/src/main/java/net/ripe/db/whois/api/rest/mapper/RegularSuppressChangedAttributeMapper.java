...
@Component
public class RegularSuppressChangedAttributeMapper extends BaseSuppressChangedAttributeMapper implements AttributeMapper {
    protected FormattedServerAttributeMapper mapper;

    @Autowired
    public RegularSuppressChangedAttributeMapper(final FormattedServerAttributeMapper mapper) {
        this.mapper = mapper;
    }
