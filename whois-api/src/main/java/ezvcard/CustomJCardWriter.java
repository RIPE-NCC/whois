 ...
 *         Time: 2:54 PM
 */
public class CustomJCardWriter implements Closeable {
     ...
     */
    public CustomJCardWriter(OutputStream out) {
     ...
     */
    public CustomJCardWriter(File file) throws IOException {
     ...
     */
    public CustomJCardWriter(Writer writer) {
        this.writer = writer;
    }
