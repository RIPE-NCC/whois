...
public class Route6 {
    ...
    private CommentedValue route6 = null;
    ...
    public Route6(final Builder builder) {
        Preconditions.checkState(builder != null);
        this.route6 = builder.route6;
    ...
    // route6
    public CommentedValue getRoute6() {
        return this.route6;
    }

    public String getRoute6Value() {
        String value = null;
        if (this.route6 != null) {
            value = this.route6.getValue();
        }
        return value;
    }
    ...
    public void validate() {
        Preconditions.checkState(route6 != null && route6.getValue() != null, "Missing (single) mandatory attribute 'route6'");
    ...
    public WhoisResources toRequest() {
        ...
        whoisObject.setType("route6");

        List<Attribute> attributes = new ArrayList<Attribute>();
        if (route6 != null) {
            if (!ATTR_NOT_IN_REQ.contains("route6")) {
                attributes.add(new Attribute("route6",
                        route6.getValue(),
                        route6.getComment(),
                        null, null));
            }
    ...
    public String toString() {
        ...
        sb.append("\n");
        appendRpslAttribute(sb, "route6", this.route6);
    ...
    public static class Builder {
        ...
        public static Builder fromResponse(WhoisResources whoisResources) {
            ...
            for (WhoisObject whoisObject : whoisResources.getWhoisObjects()) {
                if (whoisObject.getType().equals("route6")) {
                    for (net.ripe.db.whois.api.rest.domain.Attribute attr : whoisObject.getAttributes()) {
                        if (attr.getName().equals("route6")) {
                            builder.setRoute6(attr.getValue(), attr.getComment());
                        }
        ...
        public Builder setRoute6(final String value) {
            Preconditions.checkState(value != null);
            this.route6 = new CommentedValue(value);
            return this;
        }
        ...
        public Builder setRoute6(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.route6 = new CommentedValue(value, comment);
            return this;
        }

        public Builder removeRoute6() {
            this.route6 = null;
            return this;
        }

        // nice to have indication of multiplicity in settter name
        public Builder mandatorySetRoute6(final String value) {
            Preconditions.checkState(value != null);
            this.setRoute6(value);
            return this;
        }

        public Builder mandatorySetRoute6(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.setRoute6(value, comment);
            return this;
        }
