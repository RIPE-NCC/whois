...
public class RtrSet {
    ...
    private CommentedValue rtrSet = null;
    ...
    public RtrSet(final Builder builder) {
        Preconditions.checkState(builder != null);
        this.rtrSet = builder.rtrSet;
    ...
    // rtr-set
    public CommentedValue getRtrSet() {
        return this.rtrSet;
    }

    public String getRtrSetValue() {
        String value = null;
        if (this.rtrSet != null) {
            value = this.rtrSet.getValue();
        }
        return value;
    }
    ...
    public void validate() {
        Preconditions.checkState(rtrSet != null && rtrSet.getValue() != null, "Missing (single) mandatory attribute 'rtr-set'");
    ...
    public WhoisResources toRequest() {
        ...
        whoisObject.setType("rtr-set");

        List<Attribute> attributes = new ArrayList<Attribute>();
        if (rtrSet != null) {
            if (!ATTR_NOT_IN_REQ.contains("rtr-set")) {
                attributes.add(new Attribute("rtr-set",
                        rtrSet.getValue(),
                        rtrSet.getComment(),
                        null, null));
            }
    ...
    public String toString() {
        ...
        sb.append("\n");
        appendRpslAttribute(sb, "rtr-set", this.rtrSet);
    ...
    public static class Builder {
        ...
        public static Builder fromResponse(WhoisResources whoisResources) {
            ...
            for (WhoisObject whoisObject : whoisResources.getWhoisObjects()) {
                if (whoisObject.getType().equals("rtr-set")) {
                    for (net.ripe.db.whois.api.rest.domain.Attribute attr : whoisObject.getAttributes()) {
                        if (attr.getName().equals("rtr-set")) {
                            builder.setRtrSet(attr.getValue(), attr.getComment());
                        }
        ...
        public Builder setRtrSet(final String value) {
            Preconditions.checkState(value != null);
            this.rtrSet = new CommentedValue(value);
            return this;
        }
        ...
        public Builder setRtrSet(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.rtrSet = new CommentedValue(value, comment);
            return this;
        }

        public Builder removeRtrSet() {
            this.rtrSet = null;
            return this;
        }

        // nice to have indication of multiplicity in settter name
        public Builder mandatorySetRtrSet(final String value) {
            Preconditions.checkState(value != null);
            this.setRtrSet(value);
            return this;
        }

        public Builder mandatorySetRtrSet(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.setRtrSet(value, comment);
            return this;
        }
