...
public class AsSet {
    ...
    private CommentedValue asSet = null;
    ...
    public AsSet(final Builder builder) {
    ...
    // as-set
    public CommentedValue getAsSet() {
        return this.asSet;
    }
    ...
    public void validate() {
        Preconditions.checkState(asSet != null && asSet.getValue() != null, "Missing (single) mandatory attribute 'as-set'");
    ...
    public WhoisResources toRequest() {
        ...
        whoisObject.setType("as-set");

        List<Attribute> attributes = new ArrayList<Attribute>();
        if (asSet != null) {
            if (!ATTR_NOT_IN_REQ.contains("as-set")) {
                attributes.add(new Attribute("as-set",
                        asSet.getValue(),
                        asSet.getComment(),
                        null, null));
            }
    ...
    public String toString() {
        ...
        sb.append("\n");
        appendRpslAttribute(sb, "as-set", this.asSet);
    ...
    public static class Builder {
        ...
        public static Builder fromResponse(WhoisResources whoisResources) {
            ...
            for (WhoisObject whoisObject : whoisResources.getWhoisObjects()) {
                if (whoisObject.getType().equals("as-set")) {
                    for (net.ripe.db.whois.api.rest.domain.Attribute attr : whoisObject.getAttributes()) {
                        if (attr.getName().equals("as-set")) {
                            builder.setAsSet(attr.getValue(), attr.getComment());
                        }
        ...
        public Builder setAsSet(final String value) {
            Preconditions.checkState(value != null);
            this.asSet = new CommentedValue(value);
            return this;
        }
        ...
        public Builder setAsSet(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.asSet = new CommentedValue(value, comment);
            return this;
        }
        ...
        public Builder mandatorySetAsSet(final String value) {
            Preconditions.checkState(value != null);
            this.setAsSet(value);
            return this;
        }

        public Builder mandatorySetAsSet(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.setAsSet(value, comment);
            return this;
        }
