...
public class PoeticForm {
    ...
    private CommentedValue poeticForm = null;
    ...
    public PoeticForm(final Builder builder) {
        Preconditions.checkState(builder != null);
        this.poeticForm = builder.poeticForm;
    ...
    // poetic-form
    public CommentedValue getPoeticForm() {
        return this.poeticForm;
    }

    public String getPoeticFormValue() {
        String value = null;
        if (this.poeticForm != null) {
            value = this.poeticForm.getValue();
        }
        return value;
    }
    ...
    public void validate() {
        Preconditions.checkState(poeticForm != null && poeticForm.getValue() != null, "Missing (single) mandatory attribute 'poetic-form'");
    ...
    public WhoisResources toRequest() {
        ...
        whoisObject.setType("poetic-form");

        List<Attribute> attributes = new ArrayList<Attribute>();
        if (poeticForm != null) {
            if (!ATTR_NOT_IN_REQ.contains("poetic-form")) {
                attributes.add(new Attribute("poetic-form",
                        poeticForm.getValue(),
                        poeticForm.getComment(),
                        null, null));
            }
        }
        if (descr != null) {
    ...
    public String toString() {
        ...
        sb.append("\n");
        appendRpslAttribute(sb, "poetic-form", this.poeticForm);
    ...
    public static class Builder {
        ...
        public static Builder fromResponse(WhoisResources whoisResources) {
            ...
            for (WhoisObject whoisObject : whoisResources.getWhoisObjects()) {
                if (whoisObject.getType().equals("poetic-form")) {
                    for (net.ripe.db.whois.api.rest.domain.Attribute attr : whoisObject.getAttributes()) {
                        if (attr.getName().equals("poetic-form")) {
                            builder.setPoeticForm(attr.getValue(), attr.getComment());
                        }
        ...
        public Builder setPoeticForm(final String value) {
            Preconditions.checkState(value != null);
            this.poeticForm = new CommentedValue(value);
            return this;
        }
        ...
        public Builder setPoeticForm(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.poeticForm = new CommentedValue(value, comment);
            return this;
        }

        public Builder removePoeticForm() {
            this.poeticForm = null;
            return this;
        }

        // nice to have indication of multiplicity in settter name
        public Builder mandatorySetPoeticForm(final String value) {
            Preconditions.checkState(value != null);
            this.setPoeticForm(value);
            return this;
        }

        public Builder mandatorySetPoeticForm(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.setPoeticForm(value, comment);
            return this;
        }
        ...
        public PoeticForm build() {
            PoeticForm obj = new PoeticForm(this);
            obj.validate();
            return obj;
        }
    }
