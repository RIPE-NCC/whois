...
public class Inetnum {
    ...
    private CommentedValue inetnum = null;
    ...
    public Inetnum(final Builder builder) {
        Preconditions.checkState(builder != null);
        this.inetnum = builder.inetnum;
    ...
    // inetnum
    public CommentedValue getInetnum() {
        return this.inetnum;
    }

    public String getInetnumValue() {
        String value = null;
        if (this.inetnum != null) {
            value = this.inetnum.getValue();
        }
        return value;
    }
    ...
    public void validate() {
        Preconditions.checkState(inetnum != null && inetnum.getValue() != null, "Missing (single) mandatory attribute 'inetnum'");
    ...
    public WhoisResources toRequest() {
        ...
        whoisObject.setType("inetnum");

        List<Attribute> attributes = new ArrayList<Attribute>();
        if (inetnum != null) {
            if (!ATTR_NOT_IN_REQ.contains("inetnum")) {
                attributes.add(new Attribute("inetnum",
                        inetnum.getValue(),
                        inetnum.getComment(),
                        null, null));
            }
    ...
    public String toString() {
        ...
        sb.append("\n");
        appendRpslAttribute(sb, "inetnum", this.inetnum);
    ...
    public static class Builder {
        ...
        public static Builder fromResponse(WhoisResources whoisResources) {
            for (WhoisObject whoisObject : whoisResources.getWhoisObjects()) {
                if (whoisObject.getType().equals("inetnum")) {
                    Builder builder = new Builder();
                    for (net.ripe.db.whois.api.rest.domain.Attribute attr : whoisObject.getAttributes()) {
                        if (attr.getName().equals("inetnum")) {
                            builder.setInetnum(attr.getValue(), attr.getComment());
                        }
        ...
        public Builder setInetnum(final String value) {
            Preconditions.checkState(value != null);
            this.inetnum = new CommentedValue(value);
            return this;
        }
        ...
        public Builder setInetnum(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.inetnum = new CommentedValue(value, comment);
            return this;
        }

        public Builder removeInetnum() {
            this.inetnum = null;
            return this;
        }

        // nice to have indication of multiplicity in settter name
        public Builder mandatorySetInetnum(final String value) {
            Preconditions.checkState(value != null);
            this.setInetnum(value);
            return this;
        }

        public Builder mandatorySetInetnum(final String value, final String comment) {
            Preconditions.checkState(value != null);
            this.setInetnum(value, comment);
            return this;
        }
        ...
        public Inetnum build() {
            Inetnum obj = new Inetnum(this);
            obj.validate();
            return obj;
        }
    }
