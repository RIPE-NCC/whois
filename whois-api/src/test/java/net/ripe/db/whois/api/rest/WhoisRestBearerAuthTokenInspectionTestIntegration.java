...
import static net.ripe.db.whois.api.ApiKeyAuthServerDummy.BASIC_AUTH_EXPIRED;
import static net.ripe.db.whois.api.ApiKeyAuthServerDummy.BASIC_AUTH_INACTIVE_TOKEN;
import static net.ripe.db.whois.api.ApiKeyAuthServerDummy.BASIC_AUTH_INVALID_ISS_API_KEY;
...
import static net.ripe.db.whois.api.ApiKeyAuthServerDummy.BASIC_AUTH_PERSON_MULTIPLE_MNT_WITH_ANY;
...
@Tag("IntegrationTest")
public class WhoisRestBearerAuthTokenInspectionTestIntegration extends AbstractHttpsIntegrationTest {
    ...
    public void create_mntner_only_data_parameter_with_bearer_token_fails_wrong_audience() {
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: The Access Token cannot be used because it was created for a\n" +
    ...
    public void delete_object_with_bearer_token_NONE_algo_jws_manually() {
        ...
        final String jwsObject = convertToJwt(BASIC_AUTH_PERSON_OWNER_MNT, oAuthTokenIntrospectDummy.getJwk(), oAuthTokenIntrospectDummy.getPort());
    ...
    public String getBearerToken(final String userKey) {
        return StringUtils.joinWith(" ","Bearer", convertToJwt(userKey, oAuthTokenIntrospectDummy.getJwk(), oAuthTokenIntrospectDummy.getPort()));
    }
    ...
    public static APIKeySession getOAuthSession(final JWTClaimsSet claimSet) throws ParseException {
