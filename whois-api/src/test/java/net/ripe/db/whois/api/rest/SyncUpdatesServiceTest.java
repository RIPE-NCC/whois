...
public class SyncUpdatesServiceTest {
    ...
    public void handle_only_data_parameter() {
        ...
        final Response response = subject.doUrlEncodedPost(request, source, data, help, nnew, diff, redirect, contentType, null, ssoToken);
    ...
    public void handle_diff_and_data_parameters() {
        ...
        final Response response = subject.doMultipartPost(request, source, data, help, nnew, diff, redirect, contentType, null, ssoToken);
    ...
    public void throw_illegal_argument_exception() {
        try {
            ...
            subject.doMultipartPost(request, source, data, help, nnew, diff, redirect, contentType, null,  ssoToken);
            fail();
