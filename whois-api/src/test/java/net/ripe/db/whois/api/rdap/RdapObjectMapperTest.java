...
public class RdapObjectMapperTest {
    ...
    public void organisation() {
        ...
        MatcherAssert.assertThat(notices.get(0).getTitle(), is("Multiple language attributes found"));
        MatcherAssert.assertThat(notices.get(0).getDescription().get(0), is("There are multiple language attributes DK,EN in ORG-AC1-TEST, but only the first language DK was returned."));
    }
