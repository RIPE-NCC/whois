...
public class MailBounceTestIntegration extends AbstractIntegrationTest {
    ...
    public void bouncing_mail_causes_address_to_be_marked_as_undeliverable() throws Exception {
        ...
        // Mail to notify-dummy-role@ripe.net failed
        ...
        // TODO: generate bounce reply to Whois for one of the mail addresses
    ...
    @Test
    public void delayed_delivery_is_not_permanent_undeliverable() {
