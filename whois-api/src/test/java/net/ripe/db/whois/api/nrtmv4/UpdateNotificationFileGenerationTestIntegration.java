...
public class UpdateNotificationFileGenerationTestIntegration extends AbstractNrtmIntegrationTest {
    ...
    public void should_not_create_new_file_if_no_changes()  {
        ...
        final NrtmNotificationFile secondIteration = getNotificationFileBySource("TEST");
    ...
    public void should_create_file_with_latest_delta_older_snapshot_version()  {
        ...
        final NrtmNotificationFile firstIteration = getNotificationFileBySource("TEST");
        ...
        final NrtmNotificationFile thirdIteration = getNotificationFileBySource("TEST");
    ...
    public void should_create_file_with_changes_both_sources()  {
        ...
        final NrtmNotificationFile testIteration = getNotificationFileBySource("TEST");

        final NrtmNotificationFile testNonAuthIteration = getNotificationFileBySource("TEST-NONAUTH");
