...
public class AbuseContactTestIntegration extends AbstractIntegrationTest {
    ...
    public void lookup_inetnum_exact_match_abuse_contact_found() {
        ...
        assertThat(result, is("" +
                ...
                "    <link xlink:type=\"locator\" xlink:href=\"http://rest-prepdev.db.ripe.net/abuse-contact/193.0.0.0 - 193.0.0.255\"/>\n" +
                "    <parameters>\n" +
    ...
    public void lookup_inetnum_child_address_abuse_contact_found() {
        ...
        assertThat(result, is("" +
                ...
                "  \"link\" : {\n" +
                "    \"type\" : \"locator\",\n" +
                "    \"href\" : \"http://rest-prepdev.db.ripe.net/abuse-contact/193.0.0.1\"\n" +
                "  },\n" +
                "  \"parameters\" : {\n" +
                "    \"primary-key\" : {\n" +
    ...
    public void lookup_inet6num_abuse_contact_found_accept_json() throws IOException {
        ...
        assertThat(result, is("" +
                ...
                "  \"link\" : {\n" +
                "    \"type\" : \"locator\",\n" +
                "    \"href\" : \"http://rest-prepdev.db.ripe.net/abuse-contact/2a00:1f78::/32\"\n" +
                "  },\n" +
                "  \"parameters\" : {\n" +
                "    \"primary-key\" : {\n" +
                "      \"value\" : \"2a00:1f78::/32\"\n" +
    ...
    public void lookup_inet6num_abuse_contact_found_accept_xml() {
        ...
        assertThat(result, is("" +
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<abuse-resources service=\"abuse-contact\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">\n" +
                "    <link xlink:type=\"locator\" xlink:href=\"http://rest-prepdev.db.ripe.net/abuse-contact/2a00:1f78::/32\"/>\n" +
                "    <parameters>\n" +
    ...
    public void lookup_autnum_abuse_contact_found_json_extension() {
        ...
        assertThat(result, containsString("" +
                ...
                "  \"link\" : {\n" +
                "    \"type\" : \"locator\",\n" +
                "    \"href\" : \"http://rest-prepdev.db.ripe.net/abuse-contact/AS333\"\n" +
                "  },"));
    }
}
