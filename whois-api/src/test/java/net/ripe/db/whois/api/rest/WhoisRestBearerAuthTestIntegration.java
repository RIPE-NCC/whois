...
@Tag("IntegrationTest")
class WhoisRestBearerAuthTestIntegration extends AbstractHttpsIntegrationTest {
    ...
    public void create_mntner_only_data_parameter_with_apiKey_fails_null_Scope() {
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: Wrong whois scope."));
    }
    ...
    public void create_mntner_only_data_parameter_with_apiKey_fails_multiple_scope_with_any() {
        ...
        final String response = SecureRestTest.target(getSecurePort(), "whois/syncupdates/test")
                .request()
                .header(HttpHeaders.AUTHORIZATION, getBearerToken(BASIC_AUTH_PERSON_MULTIPLE_MNT_WITH_ANY))
                .post(Entity.entity("DATA=" +  SyncUpdateUtils.encode(mntner),
                        MediaType.valueOf("application/x-www-form-urlencoded")), String.class);

        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: Whois scopes can either have ANY or specific maintainers"));
    }
    ...
    public void create_mntner_with_apiKey_fails_limit_exceed() {
        ...
        final String response = SecureRestTest.target(getSecurePort(), "whois/syncupdates/test")
                .request()
                .header(HttpHeaders.AUTHORIZATION, getBearerToken(BASIC_AUTH_PERSON_MNT_EXCEED_LIMIT))
                .post(Entity.entity("DATA=" +  SyncUpdateUtils.encode(mntner),
                        MediaType.valueOf("application/x-www-form-urlencoded")), String.class);
    ...
    @Test
    public void lookup_correct_bearer_token_with_sso_and_wrong_audience() {
    ...
    public void lookup_correct_bearer_token_no_sso_in_mnt_by_and_filtered() {
        ...
        final WhoisResources whoisResources = SecureRestTest.target(getSecurePort(), "whois/test/irt/irt-test?unfiltered")
                .request()
                .header(HttpHeaders.AUTHORIZATION, getBearerToken(BASIC_AUTH_TEST_NO_MNT))
                .get(WhoisResources.class);
    ...
    public void lookup_correct_bearer_token_with_multiple_mnt_scope_and_sso_and_unfiltered() {
        ...
        WhoisResources whoisResources = SecureRestTest.target(getSecurePort(), "whois/test/mntner/OWNER-MNT?unfiltered")
                .request()
                .header(HttpHeaders.AUTHORIZATION, getBearerToken(BASIC_AUTH_PERSON_MULTIPLE_MNT))
                .get(WhoisResources.class);
    ...
    public void delete_object_with_bearer_token_NONE_algo_jws_manually() {
        ...
        final String jwsObject = convertToOauthJwt(BASIC_AUTH_PERSON_OWNER_MNT, oAuthTokenIntrospectDummy.getJwk(), oAuthTokenIntrospectDummy.getPort());
    ...
    public void create_mntner_only_data_parameter_with_bearer_token_fails_expired_session(){
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: [OAUTH] Token has expired"));
    }
    ...
    public void create_mntner_only_data_parameter_with_bearer_token_fails_invalid_issued_at_claim(){
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: [OAUTH] An error occurred while attempting to decode the Jwt: Token\n" +
                "            issued in future"));
    }
    ...
    public void create_mntner_only_data_parameter_with_bearer_token_fails_wrong_audience() {
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: [OAUTH] An error occurred while attempting to decode the Jwt:\n" +
                "            Session cannot be used because it was created for a different\n" +
    ...
    public void create_mntner_only_data_parameter_with_bearer_token_fails_invalid_iss_claim(){
        ...
        assertThat(response, containsString("Create FAILED: [mntner] SSO-MNT"));
        assertThat(response, containsString("***Warning: [OAUTH] An error occurred while attempting to decode the Jwt: The\n" +
    ...
    public String getBearerToken(final String userKey) {
    ...
    public static AbstractOAuthSession getOAuthSession(final JWTClaimsSet claimSet) throws ParseException {
        return new DefaultOauthSession.Builder()
