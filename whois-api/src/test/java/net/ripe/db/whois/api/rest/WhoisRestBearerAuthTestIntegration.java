...
@Tag("IntegrationTest")
public class WhoisRestBearerAuthTestIntegration extends AbstractHttpsIntegrationTest {
    ...
    public static String getBearerToken(final String userKey) {
        return StringUtils.joinWith(" ","Bearer", convertToJwt(userKey));
    }
