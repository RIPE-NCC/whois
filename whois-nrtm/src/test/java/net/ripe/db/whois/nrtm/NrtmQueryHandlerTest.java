...
public class NrtmQueryHandlerTest {
    ...
    public void setup() {
        ...
        lenient().when(serialDaoMock.getByIdForNrtm(1)).thenReturn(new SerialEntry(1, Operation.UPDATE, true, 1, 1000, 1000, inetnum.toByteArray()));
        ...
        lenient().when(serialDaoMock.getByIdForNrtm(2)).thenReturn(new SerialEntry(2, Operation.UPDATE, true, 2, 1000, 1000, person.toByteArray()));
