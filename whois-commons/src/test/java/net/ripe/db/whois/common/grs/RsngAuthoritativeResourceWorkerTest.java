...
public class RsngAuthoritativeResourceWorkerTest {
    ...
    private static final String COMMON_API_KEY = "ncc-internal-api-key";
    ...
    public void setup() {
        ...
        when(builderAsn.header(eq(COMMON_API_KEY), eq("apikey"))).thenReturn(builderAsn);
        ...
        when(builderIpv4.header(eq(COMMON_API_KEY), eq("apikey"))).thenReturn(builderIpv4);
        ...
        when(builderIpv6.header(eq(COMMON_API_KEY), eq("apikey"))).thenReturn(builderIpv6);
