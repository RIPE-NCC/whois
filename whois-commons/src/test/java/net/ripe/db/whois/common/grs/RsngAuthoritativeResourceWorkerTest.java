...
public class RsngAuthoritativeResourceWorkerTest {
    ...
    public void setup() {
        ...
        when(builderAsn.header(eq(RIPE_API_KEY), eq("apikey"))).thenReturn(builderAsn);
        ...
        when(builderIpv4.header(eq(RIPE_API_KEY), eq("apikey"))).thenReturn(builderIpv4);
        ...
        when(builderIpv6.header(eq(RIPE_API_KEY), eq("apikey"))).thenReturn(builderIpv6);
