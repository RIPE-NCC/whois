...
@Component
public class Ipv4Tree extends CachedIpTree<Ipv4Resource, Ipv4Entry> {
    @Autowired
    public Ipv4Tree(final IpTreeCacheManager ipTreeCacheManager, final SourceContext sourceContext) {
    ...
    IntervalMap<Ipv4Resource, Ipv4Entry> getIntervalMap(final IpTreeCacheManager.NestedIntervalMaps nestedIntervalMaps) {
        return nestedIntervalMaps.getIpv4TreeCache();
    }
}
