...
public class DummifierNrtm implements Dummifier {
    ...
    static final Map<ObjectType, List<AttributeType>> ATTRIBUTES_TO_KEEP_OBJECT_TYPE = Map.of(
            ...
            ObjectType.ORGANISATION, Lists.newArrayList(AttributeType.REG_NR, AttributeType.ABUSE_C,AttributeType.COUNTRY,AttributeType.LAST_MODIFIED,AttributeType.CREATED));
