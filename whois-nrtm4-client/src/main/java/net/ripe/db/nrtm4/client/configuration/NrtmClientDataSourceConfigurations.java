package net.ripe.db.nrtm4.client.configuration;
...
import static net.ripe.db.whois.common.configuration.DataSourceConfigurations.DRIVER_CLASS_NAME;
import static net.ripe.db.whois.common.configuration.DataSourceConfigurations.createDataSource;
