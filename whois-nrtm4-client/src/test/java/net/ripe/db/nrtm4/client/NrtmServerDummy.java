...
public class NrtmServerDummy implements Stub {
    ...
    public void setFakeHashMocks(){
        ...
        mocks.add(new NrtmResponseMock("/nrtmv4/RIPE/update-notification-file.jose", "nrtm-signature.json", "application/json"));
        mocks.add(new NrtmResponseMock("/nrtmv4/RIPE-NONAUTH/update-notification-file.jose", "nrtm-signature.json", "application/json"));
