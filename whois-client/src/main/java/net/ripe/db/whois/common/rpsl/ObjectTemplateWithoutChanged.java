...
public final class ObjectTemplateWithoutChanged extends ObjectTemplate {

    private ObjectTemplateWithoutChanged(final ObjectType objectType, final int orderPosition, final AttributeTemplate... attributeTemplates) {
        super(objectType, orderPosition, attributeTemplates);
    }

    public ObjectTemplateWithoutChanged() {
        super();
    }

    protected void init() {
        final ArrayList<ObjectTemplateWithoutChanged> objectTemplates = Lists.newArrayList(

                new ObjectTemplateWithoutChanged(ObjectType.AS_BLOCK, 7,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.AS_SET, 9,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.AUT_NUM, 8,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.DOMAIN, 30,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.FILTER_SET, 21,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.INET_RTR, 15,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.INET6NUM, 6,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.INETNUM, 5,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.IRT, 41,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.KEY_CERT, 45,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.MNTNER, 40,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.ORGANISATION, 48,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.PEERING_SET, 22,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.PERSON, 50,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.POEM, 37,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.POETIC_FORM, 36,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.ROLE, 49,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.ROUTE_SET, 12,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.ROUTE, 10,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.ROUTE6, 11,
                ...
                new ObjectTemplateWithoutChanged(ObjectType.RTR_SET, 23,
