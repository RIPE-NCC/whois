...
public enum InetnumStatus implements InetStatus {
    ...
    static {
        ...
        PARENT_STATUS.put(LEGACY, Lists.<InetStatus>newArrayList(ALLOCATED_PA, ALLOCATED_PI, ALLOCATED_UNSPECIFIED, LIR_PARTITIONED_PA, LIR_PARTITIONED_PI, SUB_ALLOCATED_PA, ASSIGNED_ANYCAST, ASSIGNED_PA, ASSIGNED_PI, EARLY_REGISTRATION, NOT_SET, LEGACY));
