...
static short[] yytable = create_yytable();
private static short[] create_yytable0() {
return new short[] {
5, 6, 1, 9, 3, 8, 3};
}
private static short[] create_yytable() {
short[] yytable0 = create_yytable0();
short[] new_yytable = new short[7];
int next = 0;
System.arraycopy(yytable0, 0, new_yytable, next, yytable0.length);
next += yytable0.length;
return new_yytable;
}
static short[] yycheck = create_yycheck();
private static short[] create_yycheck0() {
return new short[] {
259, 260, 257, 10, 258, 262, 262};
}
private static short[] create_yycheck() {
short[] yycheck0 = create_yycheck0();
short[] new_yycheck = new short[7];
int next = 0;
System.arraycopy(yycheck0, 0, new_yycheck, next, yycheck0.length);
next += yycheck0.length;
return new_yycheck;
}
