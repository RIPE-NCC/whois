...
public interface AttributeSyntax extends Documented {
    ...
    AttributeSyntax EMAIL_SYNTAX = new AttributeSyntaxParser(new AttributeParser.EmailParser(), "" +
    ...
    AttributeSyntax GEOFEED_SYNTAX = new GeofeedSyntax();
    ...
    AttributeSyntax ORG_NAME_SYNTAX = new AttributeSyntaxRegexp(
            ...
            "If this don't comply your requirements, we suggest to use remarks or description attribute"
    );
