...
public class Latin1Conversion {
    ...
    public static String convertAndSubstitute(@Nonnull final String value) {
        return new String(convert(convertToBytes(value)), StandardCharsets.ISO_8859_1);
    }

    public static String substitute(@Nonnull final String value) {
        return new String(convert(value.getBytes(StandardCharsets.ISO_8859_1)), StandardCharsets.ISO_8859_1);
    }

    private static byte[] convertToBytes(@Nonnull final String value) {
    ...
    public static String convert(@Nonnull final String value) {
        return new String(convertToBytes(value), StandardCharsets.ISO_8859_1);
    }
