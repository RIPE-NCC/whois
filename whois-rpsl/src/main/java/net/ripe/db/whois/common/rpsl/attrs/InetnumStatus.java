...
public enum InetnumStatus implements InetStatus {
    ...
    static {
        ...
        PARENT_STATUS.put(AGGREGATED_BY_LIR, EnumSet.of(ALLOCATED_PA, SUB_ALLOCATED_PA, LIR_PARTITIONED_PA));

        PARENT_STATUS.put(ALLOCATED_UNSPECIFIED, EnumSet.of(ALLOCATED_UNSPECIFIED));
        PARENT_STATUS.put(LIR_PARTITIONED_PA, EnumSet.of(ALLOCATED_UNSPECIFIED, ALLOCATED_PA, LIR_PARTITIONED_PA));
