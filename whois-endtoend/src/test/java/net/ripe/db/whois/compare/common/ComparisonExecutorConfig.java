...
public class ComparisonExecutorConfig extends QueryExecutorConfiguration {
    ...
    public static ComparisonExecutorConfig PRE1 = new ComparisonExecutorConfig("db-pre-1.prepdev.ripe.net", 1043, 1044, 1080, 1081, ResponseFormat.DEFAULT);
    public static ComparisonExecutorConfig PRE2 = new ComparisonExecutorConfig("db-pre-2.prepdev.ripe.net", 1043, 1044, 1080, 1081, ResponseFormat.DEFAULT);
