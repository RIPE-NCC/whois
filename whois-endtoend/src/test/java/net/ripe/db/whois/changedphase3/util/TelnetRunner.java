...
public class TelnetRunner extends AbstractScenarioRunner {
    ...
    public void search(final Scenario scenario) {
        ...
        try {
            ...
            final String result = new TelnetWhoisClient(QueryServer.port).sendQuery("-rB TESTING-MNT");
    ...
    public void meta(final Scenario scenario) {
        try {
            final String result = new TelnetWhoisClient(QueryServer.port).sendQuery("-t mntner");
