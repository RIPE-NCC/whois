...
abstract class BaseSpec extends Specification {
    ...
    private static WhoisServer whoisServer
    private static JettyConfig jettyConfig
    private static MailUpdatesTestSupport mailUpdatesTestSupport
    private static MailSenderStub mailSenderStub
    private static DnsGatewayStub dnsGatewayStub
    private static IpTreeUpdater ipTreeUpdater
    private static IpRanges ipRanges
    private static Collection<Stub> stubs
    private static MessageDequeue messageDequeue
