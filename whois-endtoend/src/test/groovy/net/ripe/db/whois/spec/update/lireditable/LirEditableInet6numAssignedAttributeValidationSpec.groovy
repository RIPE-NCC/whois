...
class LirEditableInet6numAssignedAttributeValidationSpec extends BaseQueryUpdateSpec {
    ...
    Map<String, String> getTransients() {
        ["ASSIGNED-MANDATORY"                   : """\
         ...
         "ASSIGNED-EXTRA"                       : """\
                ...
                source:       TEST
                """,
         "ASSIGNED-RIPE-NCC-LEGACY-MNTNER"      : """\
                inet6num:     2001::/20
                netname:      TEST-NET-NAME
                country:      NL
                org:          ORG-LIR1-TEST
                ...
                source:       TEST
                """,
         "ASSIGNED-EXTRA-RIPE-NCC-LEGACY-MNTNER": """\
                inet6num:     2001::/20
                netname:      TEST-NET-NAME
                country:      NL
                org:          ORG-LIR1-TEST
    ...
    def "modify inet6num, add (all) lir-unlocked attributes by lir"() {
        given:
        syncUpdate(getTransient("ASSIGNED-MANDATORY") + "override: denis, override1")
    ...
    def "modify inet6num, change (all) lir-unlocked attributes by lir"() {
        ...
        syncUpdate(getTransient("ASSIGNED-EXTRA") + "override: denis, override1")
    ...
    def "modify inet6num, cannot change ripe-ncc mntner (mnt-lower) by lir"() {
        given:
        syncUpdate(getTransient("ASSIGNED-RIPE-NCC-LEGACY-MNTNER") + "override: denis, override1")
        syncUpdate(getTransient("IRT") + "override: denis, override1")
    ...
    def "modify inet6num, cannot delete ripe-ncc mntner (mnt-lower) by lir"() {
        given:
        syncUpdate(getTransient("ASSIGNED-EXTRA-RIPE-NCC-LEGACY-MNTNER") + "override: denis, override1")
        syncUpdate(getTransient("IRT") + "override: denis, override1")
