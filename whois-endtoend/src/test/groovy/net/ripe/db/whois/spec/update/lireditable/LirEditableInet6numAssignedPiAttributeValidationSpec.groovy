...
class LirEditableInet6numAssignedPiAttributeValidationSpec extends BaseLirEditableAttributeValidationSpec {

    // data for tests
    def resourceType = "inet6num"
    def resourceValue = "2001::/20"
    def resourceStatus = "ASSIGNED PI"
    ...
    def "modify resource, cannot change (mnt-lower) lir-unlocked attributes by lir"() {
        given:
        syncUpdate(getTransient("IRT") + "override: denis, override1")
