...
public class SnapshotFileGeneratorIntegrationTest extends AbstractNrtm4IntegrationBase {
    ...
    public void snapshot_file_is_generated_and_written_to_disk() throws IOException {
        ...
        final String sessionID;
        {
            ...
            final PublishableNrtmFile snapshotFile = psfList.stream().filter(psf -> psf.getSource().getSource().toString().equals("TEST")).findFirst().orElseThrow();
            ...
            assertThat(snapshotFile.getSource().getSource(), is(sourceRepository.getWhoisSource().orElseThrow().getSource()));
