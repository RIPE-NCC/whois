...
@Component
public class RoleRefAuthentication extends ReferenceAuthentication {
    ...
    public RoleRefAuthentication(AuthenticationModule credentialValidators, RpslObjectDao rpslObjectDao) {
    ...
    public List<RpslObject> authenticate(PreparedUpdate update, UpdateContext updateContext) throws AuthenticationFailedException {
        return authenticate(update, updateContext, getCandidates(update, updateContext, ObjectType.ROLE,
