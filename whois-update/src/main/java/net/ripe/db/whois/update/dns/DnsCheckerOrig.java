...
@Component
public class DnsCheckerOrig implements DnsChecker {
    private static final Logger LOGGER = LoggerFactory.getLogger(DnsCheckerOrig.class);
    ...
    @Autowired
    public DnsCheckerOrig(final DnsGateway dnsGateway) {
