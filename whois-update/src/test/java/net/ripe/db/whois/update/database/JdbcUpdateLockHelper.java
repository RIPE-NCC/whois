...
@Component
public class JdbcUpdateLockHelper implements UpdateLockHelper {
    ...
    @Autowired
    public JdbcUpdateLockHelper(@Qualifier("sourceAwareDataSource") final DataSource dataSource, final UpdateLockDao updateLockDao) {
