...
public class AttributeGeneratorTest {
    ...
    public void generate_attributes_for_x509_certificate() {
        ...
        RpslObject updatedObject = subject.generateAttributes(keycert, update, updateContext);
    ...
    public void unknown_certificate() {
        RpslObject keycert = RpslObject.parse("key-cert: unknown");
    ...
    public void person_object_not_updated() {
        RpslObject person = RpslObject.parse("person: first last\nnic-hdl: FL-TEST");

        RpslObject updatedObject = subject.generateAttributes(person, update, updateContext);
