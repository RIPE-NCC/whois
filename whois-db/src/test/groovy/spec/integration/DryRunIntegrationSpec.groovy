...
class DryRunIntegrationSpec extends BaseWhoisSourceSpec {
    ...
    def "dry run with multiple updates triggered by diff keyword"() {
        def org = new SyncUpdate(diff: true, data: """\
            organisation: AUTO-1
            org-name:     Ripe NCC organisation 1
            org-type:     OTHER
            address:      Singel 258
    ...
    def "dry run email updated triggered by diff keyword"() {
      when:
    ...
    def "dry run email with multiple updates triggered by diff keyword"() {
      when:
        def message = send new Message(subject: "DIFF", body: """\
            organisation: AUTO-1
            org-name:     Ripe NCC organisation
    ...
    def "dry run create organisation with AUTO key triggered by diff keyword"() {
      when:
        def response = syncUpdate new SyncUpdate(diff: true, data: """\
            organisation: AUTO-1
            org-name:     Ripe NCC organisation
            org-type:     OTHER
            address:      Singel 258
      ...
      when:
        def response2 = syncUpdate new SyncUpdate(diff:true, data: """\
            organisation: AUTO-1
            org-name:     Ripe NCC organisation
            org-type:     OTHER
            address:      Singel 258
