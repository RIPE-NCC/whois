...
import net.ripe.db.whois.scheduler.task.grs.RadbGrsSource;
...
public class RadbGrsScheduledImport implements DailyScheduledTask {

    private final GrsImporter grsImporter;
    private final GrsSource grsSource;

    public RadbGrsScheduledImport(final GrsImporter grsImporter,
                                  final RadbGrsSource grsSource) {
    ...
    @SchedulerLock(name = "RadbGrsImporter")
    public void run() {
