...
@Component
public class IpAccessControlListManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(IpAccessControlListManager.class);

    static final int IPV6_NETMASK = 64;

    private final DateTimeProvider dateTimeProvider;
    private final IpResourceConfiguration resourceConfiguration;
    private final IpAccessControlListDao accessControlListDao;
    private final PersonalObjectAccounting personalObjectAccounting;
    private final IpRanges ipRanges;

    @Autowired
    public IpAccessControlListManager(final DateTimeProvider dateTimeProvider,
                                      final IpResourceConfiguration resourceConfiguration,
                                      final IpAccessControlListDao accessControlListDao,
