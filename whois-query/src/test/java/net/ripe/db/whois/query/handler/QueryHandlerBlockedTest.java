...
public class QueryHandlerBlockedTest {
    ...
    public void blocked_permanently() {
        when(accessControlListManager.isDenied(remoteAddress, null)).thenReturn(true);
    ...
    public void blocked_permanently_proxy_client() {
        ...
        lenient().when(accessControlListManager.isDenied(clientAddress, null)).thenReturn(true);
    ...
    public void blocked_temporary() {
        when(accessControlListManager.canQueryPersonalObjects(remoteAddress, null)).thenReturn(false);
    ...
    public void blocked_temporary_proxy_client() {
        ...
        when(accessControlListManager.canQueryPersonalObjects(remoteAddress, null)).thenReturn(true);
        when(accessControlListManager.isAllowedToProxy(remoteAddress)).thenReturn(true);
        when(accessControlListManager.canQueryPersonalObjects(clientAddress, null)).thenReturn(false);
