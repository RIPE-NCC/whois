...
public class SimpleTestIntegration extends AbstractQueryIntegrationTest {
    ...
    public void testLoggingNonProxy() {
        final String response = telnetWhoisClient.sendQuery("-rBGxTinetnum 81.80.117.237 - 81.80.117.237");
    ...
    public void testLocalhostAllowedToProxyRequest() {
        final String response = telnetWhoisClient.sendQuery("-V 10.0.0.1 -rBGxTinetnum 81.80.117.237 - 81.80.117.237");
    ...
    public void testLoggingProxy() throws InterruptedException {
        final String response = telnetWhoisClient.sendQuery("help\n");
    ...
    public void testEmptyQueries() throws Exception {
        for (int i = 0; i < 10; i++) {
            final String response = telnetWhoisClient.sendQuery("\n");
    ...
    public void multiple_lines_unsupported() throws Exception {
        telnetWhoisClient.sendQuery("-rwhois V-1.5 jwhois 1.0\n-rwhois V-1.5 jwhois 2.0\n-rwhois V-1.5 jwhois 3.0\n");
    }
    ...
    public void testGetVersion() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-q version");
    ...
    public void testGetVersion_with_long_option() throws Exception {
        final String response = telnetWhoisClient.sendQuery("--version");
    ...
    public void testGetInvalidInetnum() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-r -T inetnum RIPE-MNT");
    ...
    public void testGetMaintainer() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-r -T mntner RIPE-MNT");
    ...
    public void testGetMaintainer_long_version() throws Exception {
        final String response = telnetWhoisClient.sendQuery("--no-referenced --select-types mntner RIPE-MNT");
    ...
    public void searchByOrganisationNameNoSearchKey() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-r -T organisation");
    ...
    public void searchByAsBlockInvalidRange() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-r -T as-block AS2 - AS1");
    ...
    public void domainQueryTrailingDot() throws Exception {
        ...
        final String response = telnetWhoisClient.sendQuery("-rT domain 9.4.e164.arpa.");
    ...
    public void reverseDomainInvalidInverseRange() throws Exception {
        final String response = telnetWhoisClient.sendQuery("80-28.79.198.195.in-addr.arpa");
    ...
    public void reverseDomainUppercaseSearch() throws Exception {
        final String response = telnetWhoisClient.sendQuery("117.80.81.IN-ADDR.ARPA");
    ...
    public void routeSimpleHierarchySearch() throws Exception {
        final String response = telnetWhoisClient.sendQuery("81.80.117.0/24AS123");
    ...
    public void routeSimpleHierarchySearchWrongAS() throws Exception {
        final String response = telnetWhoisClient.sendQuery("81.80.117.0/24AS456");
    ...
    public void routeDefaultHierarchySearchForNonexistant() throws Exception {
        final String response = telnetWhoisClient.sendQuery("81.80.117.54/32AS123");
    ...
    public void routeAllLessSpecificHierarchySearchForNonexistant() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-L 81.80.117.54/32AS123");
    ...
    public void routeOneLessSpecificHierarchySearchForExisting() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-l 81.80.117.0/24AS123");
    ...
    public void routeOneLessSpecificHierarchySearchAtTopLevel() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-l 81.80.0.0/16AS123");
    ...
    public void routeOneMoreSpecificHierarchySearchAtBottomLevel() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-m 81.80.117.0/24AS123");
    ...
    public void routeOneMoreSpecificHierarchySearch() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-m 81.80.0.0/16AS123");
    ...
    public void routeOneMoreSpecificHierarchySearchAtTopLevel() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-m 0.0.0.0/0AS123");
    ...
    public void routeOneMoreSpecificHierarchySearchAtAlmostTopLevel() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-m 81.0.0.0/8AS123");
    ...
    public void routeAllMoreSpecificHierarchySearchAtTopLevelWrongAS() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-M 81.0.0.0/8A456");
    ...
    public void personQueryWithoutSearchKey() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-rT person");
    ...
    public void invalidAsBlockReturnsErrorMessage() throws Exception {
        final String response = telnetWhoisClient.sendQuery("-rT as-block AS2-AS1");
    ...
    public void findByEmailAttributeShouldNotReturnDuplicates() throws Exception {
        ...
        final String response = telnetWhoisClient.sendQuery("denis@ripe.net");
    ...
    public void unsupported_query() {
        final String response = telnetWhoisClient.sendQuery("(85.115.248.176)");
    ...
    public void more_specific_inetnum_query_including_domain_object() {
        final String response = telnetWhoisClient.sendQuery("-r -d -M 81.80.0.0/16");
    ...
    public void check_inverse_with_objecttype() {
        final String response = telnetWhoisClient.sendQuery("-T aut-num -i member-of AS-123");
    ...
    public void query_object_missing_references() {
        ...
        final String lookupResponse = telnetWhoisClient.sendQuery("0/0");
        ...
        final String inverseLookupResponse = telnetWhoisClient.sendQuery("-i mnt-by TEST-ROOT-MNT");
    ...
    public void query_grs() {
        ...
        final String response = telnetWhoisClient.sendQuery("-s TEST-GRS AS760-MNT");
    ...
    public void query_domain_versions() throws Exception {
        ...
        String response = telnetWhoisClient.sendQuery("--list-versions 117.80.81.in-addr.arpa");
    ...
    public void invalid_combination() {
        final String response = telnetWhoisClient.sendQuery("-v role -v person");
    ...
    public void validSyntax_missing_attribute() {
        ...
        final String result = telnetWhoisClient.sendQuery("--valid-syntax DEL-MNT");
    ...
    public void validSyntax_wrong_queryflag_combination() {
        final String wrongFlagShowVersion = telnetWhoisClient.sendQuery("--valid-syntax --show-version 1 ADM-TEST");
        assertThat(wrongFlagShowVersion, containsString("The flags \"--valid-syntax\" and \"--show-version\" cannot be used together."));

        final String wrongFlagListVersions = telnetWhoisClient.sendQuery("--valid-syntax --list-versions 1 ADM-TEST");
        assertThat(wrongFlagListVersions, containsString("The flags \"--valid-syntax\" and \"--list-versions\" cannot be used together."));

        final String wrongFlagDiffVersions = telnetWhoisClient.sendQuery("--valid-syntax --diff-versions 1 ADM-TEST");
        assertThat(wrongFlagDiffVersions, containsString("The flags \"--valid-syntax\" and \"--diff-versions\" cannot be used together."));

        final String wrongFlagValidNovalid = telnetWhoisClient.sendQuery("--valid-syntax --no-valid-syntax 1 ADM-TEST");
    ...
    public void novalidSyntax_incorrect_syntax() {
        ...
        final String result = telnetWhoisClient.sendQuery("--no-valid-syntax DEL-MNT");
    ...
    public void route6_correct_rebuild() {
        ...
        ipTreeUpdater.rebuild();
        final String query = telnetWhoisClient.sendQuery("2aaa:6fff::/48");
    ...
    public void find124() {
        ...
        ipTreeUpdater.rebuild();
        final String query = telnetWhoisClient.sendQuery("2a02:27d0:116:fffe:fffe:fffe:1671::/124");
    ...
    public void autnum_status_description() {
        final String query = telnetWhoisClient.sendQuery("-v aut-num");
    ...
    public void person_with_non_ascii_latin1_characters() {
        ...
        final String query = telnetWhoisClient.sendQuery("TU1-TEST");
