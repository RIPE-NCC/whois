...
public class VersionTestIntegration extends AbstractQueryIntegrationTest {
    ...
    public void noObject() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions AS-FOO"));
        assertThat(response, containsString(QueryMessages.noResults("TEST").toString()));
    }

    @Test
    public void noHistory() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions AS-TEST"));
        assertThat(response, matchesPattern("1\\s+" + historyTimestampToString(1032338056) + "\\s+ADD/UPD"));
    }

    @Test
    public void noHistoryOnDeletedObject() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions test.sk"));
    ...
    public void simpleHistory() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions AS20507"));
    ...
    public void personTest() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions TU1-TEST"));
    ...
    public void roleTest() {
        ...
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions SU1-TEST"));
        assertThat(response, containsString(QueryMessages.versionPersonRole("ROLE", "SU1-TEST").toString()));
    }

    @Test
    public void getObjects() {
        String response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1 AS20507"));
        ...
        response = stripHeader(telnetWhoisClient.sendQuery("--show-version 2 AS20507"));
        assertThat(response, containsFilteredVersion(
                RpslObject.parse("" +
                        "aut-num: AS20507\n" +
                        "as-name: AsName\n" +
        ...
        response = stripHeader(telnetWhoisClient.sendQuery("--show-version 3 AS20507"));
        assertThat(response, containsFilteredVersion(
                RpslObject.parse("" +
                        "aut-num: AS20507\n" +
                        "as-name: AsName\n" +
        ...
        response = stripHeader(telnetWhoisClient.sendQuery("--show-version 4 AS20507"));
        assertThat(response, containsFilteredVersion(
                RpslObject.parse("" +
                        "aut-num: AS20507\n" +
                        "as-name: AsName\n" +
        ...
        response = stripHeader(telnetWhoisClient.sendQuery("--show-version 140 AS20507"));
    ...
    public void versionFilteringNotAllowed() {
        ...
        String response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1 MAINT-ME"));
        System.out.println(response);
        assertThat(response, containsFilteredVersion(object));

        response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1 -B MAINT-ME"));
    ...
    public void listVersions_to_suppress_filtered_warning() {
        final String result = telnetWhoisClient.sendQuery("--list-versions AS-TEST");
        assertThat(result, not(containsString("Note: this output has been filtered")));
    }

    @Test
    public void showVersion_bizarreVersionNumber() {
        final String response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1.5 MAINT-ME"));
    ...
    public void showVersion_lastVersionDeleted() {
        ...
        final String response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1 TEST-DBM"));
    ...
    public void listVersion_inetnum_without_space_in_range() throws Exception {
        ...
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions 192.168.0.0-192.168.255.255"));
    ...
    public void listVersions_undeleted() {
        ...
        final String response = stripHeader(telnetWhoisClient.sendQuery("--list-versions TEST-DBM"));
        assertThat(response, containsString("This object was deleted on"));
        assertThat(response, containsString("ADD/UPD"));
    }
    ...
    public void showVersion_timestamps() {
        ...
        final String response = stripHeader(telnetWhoisClient.sendQuery("--show-version 1 TO1-TEST"));
